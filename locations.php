...
$sql = "SELECT id_location, title_l, description_l, pic_l FROM location";
...
// output data of each row
    while($row = mysqli_fetch_assoc($query)) {
        ...
        echo "<h2 class='text-primary' id='{$row['title_l']}'>Title: <span class='text-muted'>" . $row["title_l"]. "</span></h2>".
            "<h2 class='text-primary'>Description: </h2><p style='font-size: 16px'>" . $row["description_l"]. "</p>";
        echo "</div>";
        echo "<div class=\"col-sm-12 col-md-2\">";
        echo "<img src=\"assets/images/{$row['pic_l']}\" alt=\"location picture\" width='200' /><div class='clearfix'></div>";
        echo "</div>";
        echo "</div>";
        echo "<hr>";
    }
