    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-6 offset-3">
                <form method="post" action="insert_location.php" enctype="multipart/form-data" class="form-group">
...
if(isset($_POST['insertData'])) {
    ...
    if(empty($title) or empty($description) or empty($picture)){
    ...
    $sql = "INSERT INTO location(title_l,description_l,pic_l) VALUES('$title','$description','$pictureName');";
