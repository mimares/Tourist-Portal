     ...
     <div class=\"row\">
        <div class=\"col-sm-4 col-md-12 col-lg-4\">
            <form method=\"post\" action=\"update_event.php\">
                <img src=\"../assets/images/{$result['pic_e']}\" alt=\"$altName[0]\" width=\"332\" height=\"500\"><br>
        </div>
        <div class=\"col-sm-8 col-md-6 col-lg-8\">
                <strong>Title: </strong>{$result['title_e']}<br>
                <strong>Description: </strong>{$result['description_e']}<br>
                <strong>Date: </strong>{$result['date_e']}<br>
